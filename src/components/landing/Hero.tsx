            ...
            <div className="h-[70dvh] bg-[#FF4A20] px-10 py-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[60%_40%] gap-4 grid-rows-1">
                    <div className="flex justify-center sm:items-start items-center flex-col pt-22 gap-4">
                        ...
                        <Link href='/dashboard' className="flex items-center bg-white px-3 py-2 text-black font-semibold w-fit rounded-lg cursor-pointer hover:bg-[#FF4A20]/60 hover:outline outline-white hover:text-white transition-all duration-400">Build Your Own Health Vault  <span className="text-xl"> →</span></Link>
                    </div>
